  ...
  <div class="app-container">
    <el-form :inline="true" :model="listQuery" class="demo-form-inline" size="mini">
      ...
      <el-form-item label="用户号码">
        <el-input v-model="listQuery.userPhone" placeholder="号码" style="width: 100px"></el-input>
      </el-form-item>
      <el-form-item label="用户性别">
        <el-select v-model="listQuery.userGender" clearable placeholder="性别" style="width: 80px">
    ...
    <el-table-column align="center" label="#" width="95">
      ...
      <el-table-column label="用户性别" width="110px" align="center">
        <template slot-scope="{row}">
          <el-tag v-if="row.userGender === 1" type="success">男</el-tag>
          <el-tag v-if="row.userGender === 0" type="success">女</el-tag>
        </template>
      </el-table-column>
...
<script>
import { fetchPv, deleteById, fetchListPage, batchDelete, selectNameByKey } from '@/api/user'
